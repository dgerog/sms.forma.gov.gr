<?php
    global $messages;
    $messages = array (
        'meta_description' => 'Automating the sending of SMS to request permission to move during lock down.',
        ...
        'select-reason' => 'Select reason to move',
        'create_sms' => 'Create SMS',
        'reason_1' => 'Visit pharmacist/ doctor (only if instructed after phone communication)',
        ...
        'reason_4' => 'Offer assistance to people in need.',
        'reason_5' => 'Attend a ceramony (funeral, wedding, baptism) according to the law, or visit divorced parents when needed to ensure communication with childrenm acording to the law.',
        'reason_6' => 'Physical outdoor excersising or walking with your pet (maximum two persons keeping the required distance of 1.5 meters among them).',
        'important' => 'IMPORTANT',
